<button id="like" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Like" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
...
<button id="dislike" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Dislike" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
...
<button id="joy" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Joy" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
	<i class="em em-joy"></i>
...
<button id="cry" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Cry" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
	<i class="em em-cry"></i>
...
<button id="love" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Love" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
...
<button id="no_mouth" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Blank Face" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
...
<button id="grin" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Grinning" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
...
<button id="expressionless" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Expressionless" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
...
<button id="tada" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Tada!" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
...
<button id="sob" data-post-id="{{ $post->id }}" data-user-id="{{ $post->user->id }}" data-tooltip="Sobbing" class="post-likes reaction" disabled="disabled" style="cursor:not-allowed;">
	<i class="em em-sob"></i>
