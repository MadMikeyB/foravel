...
<html lang = "en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{ Theme::asset('css/sweetalert.css', null, true) }}" media="screen" />
	...
	<body class="has-top-menu">
		<!-- BEGIN #slider-imgs -->
		<div id="slider-imgs">
			<div class="featured-img-box" style="background-image: url(https://source.unsplash.com/category/nature/daily);">
		...
		<div id="top-layer">
			...
			<section id="content">
				<header id="header" class="needspadding">
					<div id="menu-bottom">
						<!-- <nav id="menu" class="main-menu width-fluid"> -->
						<nav id="menu" class="main-menu">
							<div class="blur-before"></div>
							<a href="{{ route('home') }}" class="header-logo left"><img src="{{ Theme::asset('images/logo.png', null, true) }}" class="logo" alt="FilesNation" title="" /></a>
		...
		<script type='text/javascript' src="{{ Theme::asset('jscript/sweetalert.min.js', null, true) }}"></script>
		@include('sweet::alert')
		@yield('scripts')
